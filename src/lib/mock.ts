...
export const SERVICES = [
  { slug: "cinematic-reels", icon: "clapperboard", title: "Cinematic Reels", description: "Story-driven vertical films crafted for Instagram, packed with mood, motion and music.", duration: "48 hr turnaround", deliverables: ["1 hero reel (9:16)", "3 platform cutdowns", "Color-graded master", "Music licensing"], price_from: "₹1,800 / reel" },
  { slug: "pre-wedding", icon: "heart", title: "Pre-Wedding Shoot", description: "Location-scouted cinematic day with couple direction and edited highlight film.", duration: "Full-day shoot", deliverables: ["1 cinematic film (2-3 min)", "1 teaser reel", "50+ edited stills", "RAW backup"], price_from: "₹1,800 / reel" },
  { slug: "birthday", icon: "cake", title: "Birthday Shoot", description: "Candid moments, décor detail, and a reel that plays back the whole day.", duration: "4-6 hr coverage", deliverables: ["1 cinematic reel", "Event highlight film", "30+ stills"], price_from: "₹1,800 / reel" },
  { slug: "reel-editing", icon: "scissors", title: "Instagram Reel Editing", description: "Send your footage — we return a scroll-stopping edit with color, cuts and captions.", duration: "24-48 hr", deliverables: ["Beat-matched edit", "Color grade", "Text/motion graphics", "2 revisions"], price_from: "₹1,800 / reel" },
  { slug: "pro-video", icon: "video", title: "Professional Video Shoot", description: "Multi-cam brand, product or event coverage with a full crew and creative direction.", duration: "Half / full day", deliverables: ["4K master", "Social cutdowns", "Motion graphics"], price_from: "₹1,800 / reel" },
];
