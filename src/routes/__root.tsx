...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Desai Siddhraj — Fashion Creator & Reel Promoter | Himmatnagar" },
      { name: "description", content: "Official portfolio of Desai Siddhraj — Fashion Creator, Reel Promoter & Brand Collaborator in Himmatnagar, Gujarat. Transforming clothing collections into high-impact Instagram Reels." },
